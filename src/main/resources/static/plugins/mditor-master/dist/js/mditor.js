...
/***/ function(module, exports, __webpack_require__) {
	...
	Renderer.prototype.table = function(header, body) {
	  return '<table style="border-spacing: 0;border-collapse: collapse;margin-top: 0;margin-bottom: 16px;display: block;width: 100%;overflow: auto;">\n'
	    + '<thead style="font-weight: bold;padding: 6px 13px;border: 1px solid #ddd;">\n'
	    + header
	    + '</thead>\n'
	    + '<tbody>\n'
	    + body
	...
	Renderer.prototype.tablerow = function(content) {
	  return '<tr style="background-color: #fff;border: 1px solid #ccc;border-collapse:collapse;">\n' + content + '</tr>\n';
	};
	
	Renderer.prototype.tablecell = function(content, flags) {
	  var type = flags.header ? 'th' : 'td';
	  var tag = flags.align
	    ? '<' + type + ' style="text-align:' + flags.align + ';background-color: #fff;border: 1px solid #ccc;border-collapse:collapse;">'
	    : '<' + type + ' style="background-color: #fff;border: 1px solid #ccc;border-collapse:collapse;">';
